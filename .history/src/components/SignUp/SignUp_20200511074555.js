    ...
    return (
      ...
      >
        ...
        <div data-style="minimal">
          ...
          >
            <p>
              <span style="color:rgb(51, 51, 51)">Informacje o </span>
              <span style="color:rgb(51, 51, 51)">
                <strong>nowych artykułach</strong>
              </span>
              <span style="color:rgb(51, 51, 51)"> i </span>
              <span style="color:rgb(51, 51, 51)">
                <strong>sposobach na skuteczną naukę programowania</strong>
              </span>
              <span style="color:rgb(51, 51, 51)"> prosto na Twój e-mail</span>
            </p>
          </div>
